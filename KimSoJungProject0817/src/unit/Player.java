...
public class Player extends JLabel {
	...
	public ImageIcon swing2 = new ImageIcon(MyFrame.class.getResource("../pl_image/swing0.gif"));
	public ImageIcon swing2_R = new ImageIcon(MyFrame.class.getResource("../pl_image/swing0_R.gif"));
